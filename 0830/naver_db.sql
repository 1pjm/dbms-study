...
-- 테이블
-- : 표 형태로 구성된 2차원 구조
-- : 열(row, record)과 행(column, field)으로 구성
...
-- 연락처 국번 phone1 char(3) null 허용
-- 전화번호 phone2 char(8) null 허용
-- 평균 키 height tinyint null 허용 - unsigned (범위 0 ~ 255)
...
-- 아이디 mem_id char(8) not null 외래키(FK)
