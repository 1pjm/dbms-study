...
-- using으로 물음표(?)에 @count 값을 대입

### 데이터 형 변환 ###

-- 데이터 타입: 문자, 숫자(정수, 실수), 날짜 등
-- 형 변환
-- : 문자형을 정수형으로 바꾸거나, 반대로 정수형을 문자형 등으로 바꾸는 것
...
-- : 전체 자리수 - 최대 65
-- : 소수점 이하의 자리수 - 최대 30
select cast(123123123 as decimal(65, 30));
